    ...
    <>
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .admin-brand-rings { display: none; }
          .admin-form-panel { padding: 28px 20px 40px; align-items: flex-start; }
          .admin-form-inner { max-width: 100%; }
          .admin-heading { font-size: clamp(24px, 7vw, 32px) !important; }
        }
      `}</style>
      ...
      <div className="admin-shell">
        ...
        <div className="admin-brand">
          {[200, 280, 360].map((d, i) => (
            <div key={i} className="admin-brand-rings" style={{
          ...
          <div style={{ position: "relative", zIndex: 2, textAlign: "center" }}>
            <div style={{
              ...
              <svg width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="#ebe5d7" strokeWidth="1.5" strokeLinecap="round">
                <rect x="3" y="11" width="18" height="11" rx="2" />
                <path d="M7 11V7a5 5 0 0 1 10 0v4" />
                <circle cx="12" cy="16" r="1.5" fill="#ebe5d7" stroke="none" />
              </svg>
            </div>
            <h2 style={{ color: "#f3e8e8", fontSize: "clamp(18px,3vw,24px)", fontWeight: 700, margin: "0 0 8px" }}>Administrator</h2>
            <p style={{ color: "rgba(243,234,234,0.8)", fontSize: 13, margin: 0, lineHeight: 1.6 }}>
        ...
        <div className="admin-form-panel">
          <div className="admin-form-inner">
            <Link href="/" style={{ display: "inline-flex", alignItems: "center", gap: 6, color: "#94a3b8", fontSize: 13, textDecoration: "none", marginBottom: 28 }}>
            ...
            <div style={{ marginBottom: 28 }}>
              ...
              <h1 className="admin-heading" style={{ fontSize: 32, fontWeight: 700, color: "#2C0A0A", margin: 0, letterSpacing: "-0.02em" }}>
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <button type="submit" disabled={loading} style={{
                ...
                fontWeight: 700, cursor: loading ? "not-allowed" : "pointer", fontFamily: "system-ui,sans-serif",
              }}>
